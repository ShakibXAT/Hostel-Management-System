 ...
 <?php
  ...
  if(isset($_POST['login'])){
    ...
    if($email_count){
      ...
      $_SESSION['AdminEmail'] = $email_pass['AdminEmail'];
  ...
  if($emailcount>0){
    ...
    if($password === $repassword){
      ...
      $insertquery = "insert into registration (firstName, lastName, NID, phoneNumber, email, AdminEmail, password, repassword) values('$firstName','$lastName','$NID','$phoneNumber','$email','$AdminEmail','$pass','$repass')";
...
<form action="<?php echo htmlentities($_SERVER['PHP_SELF']);?> " method="POST">
  <div class="container">
    ...
    <label for="email"><b>Admin Email</b></label><br>
    <input type="text" placeholder="Enter Admin Email Address" name="AdminEmail" required><br>
