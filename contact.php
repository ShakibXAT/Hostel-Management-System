...
<header class="header">
  <a class="header head">Hostel Management contacts</a>
...
<?php 
  include 'loginDatabase.php';
    ...
    $Admin = mysqli_real_escape_string($con, $_SESSION['AdminEmail']);

    $sql = "SELECT firstName, lastName, email, NID, phoneNumber  FROM adminregistration WHERE email='$Admin'";
